...
For i = fr To lr
    ...
    'MD LD PLA AKE Blank
    If Application.WorksheetFunction.CountA(Sheets("PAX").Range("I" & i & ":L" & i)) = 0 Then
...
For i = fr To lr
    ...
    ElseIf Application.WorksheetFunction.CountIf(Sheets("Code").Range("B:B"), code) > 0 Then
        Sheets("PAX").Range("W" & i) = code
        Sheets("PAX").Range("X" & i) = code
    Else
        Sheets("PAX").Range("W" & i & ":X" & i).Interior.Color = RGB(0, 0, 0)
    End If
Next i
...
For i = fr To lr
    ...
    'MD LD PLA AKE Blank
    If Application.WorksheetFunction.CountA(Sheets("FRT").Range("I" & i & ":L" & i)) = 0 Then
...
For i = fr To lr
    ...
    ElseIf Application.WorksheetFunction.CountIf(Sheets("Code").Range("B:B"), code) > 0 Then
        Sheets("FRT").Range("W" & i) = code
        Sheets("FRT").Range("X" & i) = code
    Else
        Sheets("FRT").Range("W" & i & ":X" & i).Interior.Color = RGB(0, 0, 0)
    End If
Next i
